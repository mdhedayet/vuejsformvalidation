<template>
  <form @submit.prevent="submitFrom">
    ...
    <div class="form-control">
      ...
      <div>
        <input id="interest-nothing" name="interest" type="checkbox" value="nothings" v-model="interest"/>
    ...
    <div class="form-control">
      ...
      <rating-controller v-model="rating"></rating-controller>
    </div>
    <div>
...
<script>
import RatingController from './RatingController.vue';
export default {
  components:{
    RatingController
  },
